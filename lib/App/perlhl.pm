...
method new($class: $opts) {
    ...
    if ($opts->{html}) {
        ...
        my $color_table = { # Readability is not so good -- play with it more
            'Bareword'          => 'white',
            'Builtin_Function'  => 'bright_white',
            'Builtin_Operator'  => 'bright_white',
            'Character'         => 'bright_red',
            'CodeTerm'          => 'bright_black',
            'Comment_Normal'    => 'bright_blue',
            'Comment_POD'       => 'bright_blue',
            'DATA'              => 'bright_black',
            'Directive'         => 'magenta',
            ...
            'Quote'             => 'bold white',
            'String'            => 'bright_cyan',
            'Subroutine'        => 'bright_yellow',
            'Symbol'            => 'white',
            'Variable_Array'    => 'bright_green',
            'Variable_Hash'     => 'bright_green',
            'Variable_Scalar'   => 'bright_green',
            'Variable_Typeglob' => 'bright_white',
        };
